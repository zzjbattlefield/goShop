...
func BrandList(ctx *gin.Context) {
	...
	rsp, err := global.GoodsClinet.BrandList(context.Background(), &proto.BrandFilterRequest{
		Pages:       int32(pnInt),
...
func NewBrand(ctx *gin.Context) {
	...
	rsp, err := global.GoodsClinet.CreateBrand(context.Background(), &proto.BrandRequest{
		Name: brandForm.Name,
		Logo: brandForm.Logo,
	})
	if err != nil {
...
func DeleteBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsClinet.DeleteBrand(context.Background(), &proto.BrandRequest{Id: int32(i)})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
...
func UpdateBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsClinet.UpdateBrand(context.Background(), &proto.BrandRequest{
		Id:   int32(i),
		Name: brandForm.Name,
		Logo: brandForm.Logo,
	})
...
func GetCategoryBrandList(ctx *gin.Context) {
	...
	rsp, err := global.GoodsClinet.GetCategoryBrandList(context.Background(), &proto.CategoryInfoRequest{
		Id: int32(i),
	})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
...
func CategoryBrandList(ctx *gin.Context) {
	...
	*/
	rsp, err := global.GoodsClinet.CategoryBrandList(context.Background(), &proto.CategoryBrandFilterRequest{})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
...
func NewCategoryBrand(ctx *gin.Context) {
	...
	rsp, err := global.GoodsClinet.CreateCategoryBrand(context.Background(), &proto.CategoryBrandRequest{
...
func UpdateCategoryBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsClinet.UpdateCategoryBrand(context.Background(), &proto.CategoryBrandRequest{
		Id:         int32(i),
		CategoryId: int32(categoryBrandForm.CategoryId),
		BrandId:    int32(categoryBrandForm.BrandId),
	})
...
func DeleteCategoryBrand(ctx *gin.Context) {
	...
	_, err = global.GoodsClinet.DeleteCategoryBrand(context.Background(), &proto.CategoryBrandRequest{Id: int32(i)})
	if err != nil {
		api.HandleGrpcErrorToHttp(err, ctx)
		return
	}
